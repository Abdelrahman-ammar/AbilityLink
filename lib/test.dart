...
//   SchoolDetail({required this.documentId});
...
//                             children: [
//                               Text(
//                                 data['school_name'] ?? 'Name of School',
//                                 style: TextStyle(
//                                     fontSize: 20,
...
//                               children: [
//                                 // Update the values with data from Firestore
//                                 Column(
//                                   mainAxisAlignment: MainAxisAlignment.center,
//                                   children: [
//                                     Text(
//                                       data['est'].toString() ?? '1990',
//                                       style: TextStyle(
//                                           fontSize: 13,
//                                           fontWeight: FontWeight.bold,
//                                           color: Colors.white),
...
//                                   children: [
//                                     Text(
//                                       data['underGraduated'].toString() ?? '400',
//                                       style: TextStyle(
//                                           fontSize: 13,
//                                           fontWeight: FontWeight.bold,
//                                           color: Colors.white),
...
//                           TextButton(
//                             onPressed: () {
//                               // Navigate to reviews page with the documentId
//                               Navigator.push(
//                                 context,
//                                 MaterialPageRoute(
//                                   builder: (context) => SchoolReviews(documentId: documentId),
//                                 ),
//                               );
//                             },
//                             child: Text(
